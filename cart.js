...
function CartDAO(database) {
    ...
    this.updateQuantity = function(userId, itemId, quantity, callback) {
        ...
        */
        ...
        // edge case if the user wants to delete item from cart by passing in quantity of 0
        if (quantity === 0) {
            this.db.collection('cart').findOneAndUpdate(
                    { userId: userId },
                    ...
                    function(err, doc) {
                        ...
                        //console.log('updateQuantity delete item', doc);
            ...
            this.db.collection('cart').findOneAndUpdate(
                    ...
                    function(err, doc) {
                        ...
                        //console.log('updateQuantity increase quantity', doc);
